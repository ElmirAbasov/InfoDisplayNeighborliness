package com.example.infodisplayneighborliness
...
class MapsActivity : AppCompatActivity(), OnMapReadyCallback {
    ...
    private lateinit var locationRequest: LocationRequest //Used to set the interval for receiving location updates in milliseconds
    private lateinit var locationCallback: LocationCallback //Used for receiving notifications from the FusedLocationProviderApi when device location has changed
